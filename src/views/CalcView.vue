...
const total = computed(() => salary1.value + salary2.value)
const save1 = computed(() => salary1.value * 0.1)
const save2 = computed(() => salary2.value * 0.1)
const debt1 = computed(() => salary1.value * 0.2)
const debt2 = computed(() => salary2.value * 0.2)
const exp1 = computed(() => salary1.value * 0.7)
const exp2 = computed(() => salary2.value * 0.7)
